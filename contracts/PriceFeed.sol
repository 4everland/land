...
contract PriceFeed is LandOwnable {
     ...
     */
	function setOracle(address _token, address _chainlinkOracle, uint32 _heartbeat, bool _isEthIndexed) public onlyOwner {
		...
		OracleRecord memory record = OracleRecord({ chainLinkOracle: newFeed, decimals: newFeed.decimals(), heartbeat: _heartbeat, isFeedWorking: true, isEthIndexed: _isEthIndexed });
